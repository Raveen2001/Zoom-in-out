...
from ultralytic.yolo.utils import LOGGER, ROOT, yaml_load
from ultralytic.yolo.utils.checks import check_requirements, check_suffix, check_version, check_yaml
from ultralytic.yolo.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(self, weights='yolov8n.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        if nn_module:
            ...
            from ultralytic.nn.tasks import attempt_load_weights
            ...
            from ultralytic.yolo.engine.exporter import EXPORT_FORMATS_TABLE
