...
from ultralytic import yolo  # noqa
from ultralytic.nn.tasks import (ClassificationModel, DetectionModel, SegmentationModel, attempt_load_one_weight,
                                  guess_model_task, nn)
from ultralytic.yolo.cfg import get_cfg
from ultralytic.yolo.engine.exporter import Exporter
from ultralytic.yolo.utils import DEFAULT_CFG, LOGGER, RANK, callbacks, yaml_load
from ultralytic.yolo.utils.checks import check_file, check_imgsz, check_yaml
from ultralytic.yolo.utils.downloads import GITHUB_ASSET_STEMS
...
class YOLO:
    ...
    def track(self, source=None, stream=False, **kwargs):
        from ultralytic.tracker.track import register_tracker
