...
from ultralytic.yolo.utils import LOGGER
            ...
            try:
                if curl or i > 0:  # curl download with retry, continue
                    ...
                    if method == 'torch':
                        ...
                        from ultralytic.yolo.utils import TQDM_BAR_FORMAT
...
def attempt_download_asset(file, repo='ultralytics/assets', release='v0.0.0'):
    ...
    from ultralytic.yolo.utils import SETTINGS
    from ultralytic.yolo.utils.checks import check_yolov5u_filename
