...
from ultralytic.yolo.utils import (AUTOINSTALL, LOGGER, ROOT, USER_CONFIG_DIR, TryExcept, colorstr, downloads, emojis,
...
def check_yolo(verbose=True):
    from ultralytic.yolo.utils.torch_utils import select_device
